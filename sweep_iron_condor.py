"""Sweep the iron condor's wing width (protection distance beyond the short
strikes) over a date range and compare results.

Usage:
    export UPSTOX_ACCESS_TOKEN=...
    python sweep_iron_condor.py --from 2026-05-01 --to 2026-09-01 \
        --short-distance 150 --widths 50 100 150 200 250 300
"""
import argparse
import statistics
...
def main() -> None:
    ...
    parser.add_argument("--short-distance", type=int, default=150)
    ...
    for width in args.widths:
        print(f"Running wing_width={width} (short_distance={args.short_distance})...")
